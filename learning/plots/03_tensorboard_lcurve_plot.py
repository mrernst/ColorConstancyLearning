...
ax.plot(np.arange(-1,100,10), mean, label='TT C3S', color=colors[3], linestyle='-')
...
std = data.std(0)
#colors = sns.color_palette("ch:start=.2,rot=-.3")
ax.plot(np.arange(-1,100,10), mean, label='sup. C3S', color=colors[3], linestyle='--')
ax.fill_between(np.arange(-1,100,10),mean - std, mean + std, color=colors[3], alpha=0.3)
...
ax.plot(np.arange(-1,100,10), np.repeat(mean, 11), linestyle=':', color=colors[3], label=r'${x}$ C3S')
...
ax.plot(np.arange(-1,100,10), mean, label='TT C3R', color=colors[4])
...
std = data.std(0)
#colors = sns.color_palette("ch:s=-.2,r=.6")
ax.plot(np.arange(-1,100,10), mean, label='sup. C3R', color=colors[4], linestyle='--')
ax.fill_between(np.arange(-1,100,10),mean - std, mean + std, color=colors[4], alpha=0.3)

# plot linear pixel baseline (random data)
mean, std, stderr = 0.49376, 0.01407744, 0.01407744/np.sqrt(5)
ax.plot(np.arange(-1,100,10), np.repeat(mean, 11), linestyle=':', color=colors[4], label=r'${x}$ C3R')
