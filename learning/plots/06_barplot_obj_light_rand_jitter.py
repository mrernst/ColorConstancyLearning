...
db_list = [rand_list, rand_list, jitter_list]
db_list2 = ['object_classifier', 'light_classifier', 'object_classifier']
...
ax.legend(frameon=False, facecolor='white', edgecolor='white', framealpha=1.0, fontsize=10, loc='upper right', bbox_to_anchor=(1, 1.19), ncols=3)
ax.set_ylim(0,1)
plt.show()
