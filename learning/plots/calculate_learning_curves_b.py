...
path_to_tmp_evaluation = args.experiment_dir + "/learning_curves/"
...
object_accuracy_array = np.zeros([1,11,1])
...
np.save(path_to_tmp_evaluation + 'object_accuracy.npy', object_accuracy_array)
...
# 
# # define an array that stores the accuracies
# lighting_accuracy_array = np.zeros([1,11,1])
# 
# 
# # layer 0 done separately
# # model,l5,l4,l3,l2,l1,l0 = load_model_and_layers(model_path=args.experiment_dir + '/models/' + f'backbone_epoch_100.pt')
